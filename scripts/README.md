...
- `reconcile-authentik-branding.py` runs through `ak shell` during service
  deployment to idempotently load the repository-owned bookshelf CSS and
  background into Authentik's supported default Brand fields.
